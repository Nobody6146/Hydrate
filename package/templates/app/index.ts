import { HydrateApp, HydrateAppOptions, HydrateRoute, HydrateRouteEvent } from "./lib/hydrate/hydrate.js";
...
export class App {
    ...
    constructor() {
        const opts:HydrateAppOptions = this.#configureOptions();
    ...
    #configureOptions():HydrateAppOptions {
    ...
    async #clientSideRouting(event:HydrateRouteEvent) {
